...
breathe_projects = {"physdes": "./doxyoutput/xml"}
breathe_default_project = "physdes"
...
project = u'physdes'
copyright = u'2019, Wai-Shing Luk'
author = u'Wai-Shing Luk'
...
latex_documents = [
  (master_doc, 'physdes.tex', u'physdes Documentation',
   u'Wai-Shing Luk', 'manual'),
]
...
man_pages = [
    (master_doc, 'physdes', u'physdes Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'physdes', u'physdes Documentation',
   author, 'physdes', 'One line description of project.',
   'Miscellaneous'),
]
